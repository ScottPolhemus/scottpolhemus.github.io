...
function resizeBubbles(){for(var e=0;e<speechBubbles.length;e++){var t=speechBubbles[e],i=$(t.children[0]).outerHeight(!0);t.setAttribute("style","height: "+i+"px")}}var $=require("jquery"),ScrollIn=require("scroll-in"),speechBubbles=$(".speech-bubble");$(function(){var e=$(window),t=$("html");$("[data-show]").on("click",function(e){var t=e.target.getAttribute("data-show");e.target.setAttribute("disabled","disabled"),$(t).attr("data-click-in","in")}),e.on("resize",resizeBubbles),t.one("typekit-finish",function(){resizeBubbles(),$("body").addClass("ready"),new ScrollIn({stagger:1500})}),t.is(".wf-active,.wf-inactive")&&t.trigger("typekit-finish")});
},{"jquery":1,"scroll-in":2}]},{},[3])
