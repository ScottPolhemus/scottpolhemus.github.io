...
function SpeechThread(e){this.bubbles=document.querySelectorAll("[data-speech-bubble]"),this.remaining=Array.prototype.slice.call(this.bubbles),this.timer=0}var $=require("jquery");SpeechThread.prototype.showNext=function(){if(clearTimeout(this.timer),this.remaining.length>0){var e=this.remaining.shift();$(window).resize(),e.setAttribute("data-speech-bubble","in"),0===this.remaining.length?$("#contact").attr("data-show","in"):this.timer=setTimeout(this.showNext.bind(this),2500)}},SpeechThread.prototype.showAll=function(){clearTimeout(this.timer),$(this.remaining).attr("data-speech-bubble","in"),this.remaining=[],$("#contact").attr("data-show","in")},module.exports=SpeechThread;
},{"jquery":1}],3:[function(require,module,exports){
function resizeBubbles(){for(var e=0;e<$bubbles.length;e++){var t=$bubbles[e];if("in"===t.getAttribute("data-speech-bubble"))t.removeAttribute("style");else{var i=$(t.children[0]).outerHeight(!0);t.setAttribute("style","height: "+i+"px")}}}var $=require("jquery"),SpeechThread=require("./lib/speech-thread.js");$(function(){var e=$(window),t=$("html"),i=$("body");$("[data-show-target]").on("click",function(e){var t=$(e.target).closest("[data-show-target]"),i=t.attr("data-show-target");i&&(e.preventDefault(),$(i).attr("data-show","in"),"#contact"===i&&$(window).scrollTop()>0&&$("html,body").animate({scrollTop:0},300),t.attr("disabled","disabled"),t.off("click"))}),t.one("typekit-finish",function(){var r=new SpeechThread;t.on("click",function(e){r.showNext()}),t.on("keypress",function(e){" "!==e.key&&"undefined"!=typeof e.key||r.showAll()}),resizeBubbles(),e.on("resize",resizeBubbles),i.addClass("ready"),r.showNext()}),t.is(".wf-active,.wf-inactive")&&t.trigger("typekit-finish")});var $bubbles=$(".speech-bubble");
},{"./lib/speech-thread.js":2,"jquery":1}]},{},[3])
