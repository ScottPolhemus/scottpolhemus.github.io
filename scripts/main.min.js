...
function resizeBubbles(){for(var e=0;e<$bubbles.length;e++){var t=$bubbles[e];if("in"===t.getAttribute("data-speech-bubble"))t.removeAttribute("style");else{var i=$(t.children[0]).outerHeight(!0);t.setAttribute("style","height: "+i+"px")}}}function showTarget(e){$(e).attr("data-click-in","in")}function SpeechThread(e){this.bubbles=document.querySelectorAll("[data-speech-bubble]"),this.remaining=Array.prototype.slice.call(this.bubbles),this.timer=0,this.showNext()}var $=require("jquery");$(function(){var e=$(window),t=$("html"),i=$("body");e.on("resize",resizeBubbles),$("[data-show]").on("click",function(e){e.preventDefault();var t=$(e.target).closest("[data-show]"),i=t.attr("data-show");i&&(showTarget(i),t.attr("disabled","disabled"),"#contact"===i&&$(window).scrollTop()>0&&$("html,body").animate({scrollTop:0},300))}),t.one("typekit-finish",function(){var e=new SpeechThread;resizeBubbles(),t.on("click",function(t){e.showNext()}),t.on("keypress",function(t){" "!==t.key&&"undefined"!=typeof t.key||e.showAll()}),i.addClass("ready")}),t.is(".wf-active,.wf-inactive")&&t.trigger("typekit-finish")});var $bubbles=$(".speech-bubble");SpeechThread.prototype.showNext=function(){if(clearTimeout(this.timer),this.remaining.length>0){var e=this.remaining.shift();resizeBubbles(),e.setAttribute("data-speech-bubble","in"),0===this.remaining.length?showTarget("#contact"):this.timer=setTimeout(this.showNext.bind(this),2500)}},SpeechThread.prototype.showAll=function(){clearTimeout(this.timer),$(this.remaining).attr("data-speech-bubble","in"),this.remaining=[],showTarget("#contact")};
},{"jquery":1}]},{},[2])
